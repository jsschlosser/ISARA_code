...
2) Collate retrievals for internal consistency analysis:
	.. code-block:: console
		...
		cd ../ISARA_code
		rm ../ISARA_data_diles/ACTIVATE/Retrievals/activate-mrg-activate-large-smps_hu25_DataRetrievals.npy
		python3 
...
3) Perform internal consistency analysis:
	...
	.. code-block:: console	
		...
		cd ../ISARA_data_files/ACTIVATE/Retrievals
...
1) Generate ambient data files assuming coarse mode is spherical sea salt:
	.. code-block:: console
		...
		cd ../ISARA_code
		mkdir ../ISARA_data_files/ACTIVATE/AmbientDataFiles/
		mkdir ../ISARA_data_files/ACTIVATE/AmbientDataFiles/Sphere_kappa0-cri1-33
		python3 

	.. code-block:: python
		
		import Gen_Amb_Data_Files
		Gen_Amb_Data_Files.Run()
		ACTIVATE
...
2) Perform external consistency analysis assuming all particles are spheres
	.. code-block:: console
		...
		cd ../ISARA_code
		mkdir ../ISARA_data_files/ACTIVATE/ExternalClosure/
		mkdir ../ISARA_data_files/ACTIVATE/ExternalClosure/Sphere_kappa0-cri1-33
		python3 
